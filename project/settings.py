...
if DEBUG:
    SECRET_KEY = 'django-insecure-ksgg^#ftx9*t8rh0e*y+j=g1m&&i8(-3nh*tm(at@s7^#j_8g1mnn'
else:
...
if DEBUG:
    ...
    EMAIL_USE_SSL = False  # Important: ne pas activer les deux à la fois
else: 
...
# Nassim: removed logging as prescribed in the docs, because tailwind start doesnt work
LOGGING = {
    'version': 1,
